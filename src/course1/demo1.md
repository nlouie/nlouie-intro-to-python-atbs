...
```
    ...
    <ipython-input-40-64397f8a6f99> in <module>
          1 while True:
    ----> 2     print('Hello, world!')
    

    ~/.conda/envs/nlouie-python-course-0/lib/python3.7/site-packages/ipykernel/iostream.py in write(self, string)
    ...
    ~/.conda/envs/nlouie-python-course-0/lib/python3.7/site-packages/ipykernel/iostream.py in schedule(self, f)
    ...
    ~/.conda/envs/nlouie-python-course-0/lib/python3.7/site-packages/zmq/sugar/socket.py in send(self, data, flags, copy, track, routing_id, group)
    ...
    ~/.conda/envs/nlouie-python-course-0/lib/python3.7/site-packages/zmq/backend/cython/checkrc.pxd in zmq.backend.cython.checkrc._check_rc()
